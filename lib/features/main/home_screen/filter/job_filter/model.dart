class JobFilter {
  ...
  late final List<JobFilterData> list;

  JobFilter.fromJson(Map<String, dynamic> json){
    status = json['status'];
    list = List.from(json['data']??[]).map((e)=>JobFilterData.fromJson(e)).toList();
  }
...
class JobFilterData {
  ...
  JobFilterData.fromJson(Map<String, dynamic> json){
    id = json['id'];
    name = json['name'];
    image = json['image'];
