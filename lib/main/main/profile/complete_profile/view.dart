              ...
              child: Column(
                children: [
                  CircularPercentIndicator(
                    ...
                    lineWidth: 10,
                    percent: 0.5,
                    center: Text("50%",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 26),),
                    progressColor: Colors.blue,

                  ),
                  SizedBox(height: 20,),
                  Text("2/4 Completed",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.blue),),
                  SizedBox(height: 8,),
